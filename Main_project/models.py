...
class DeliveryAgentApplication(models.Model):
    user = models.OneToOneField(CustomUser, on_delete=models.CASCADE)
    ...
    def __str__(self):
        return f"Delivery Agent Application for {self.user.username}"
